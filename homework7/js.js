...
const map = {
  ...
  render(snakePointsArray, foodPoint) {
    ...
    this.usedCells.push(foodCell); //мы в аргумент поставили просто точку с координатами, а нужно поставить ячейку.
  },
};
 ...
 * @property {int} maxX Максимальное значение позиции змейки по оси Х.
 * @property {int} maxY Максимальное значение позиции змейки по оси Y.
 */
const snake = {
  body: null,
  direction: null,
   ...
   * @param {int} maxX Максимальная позиция змейки по оси Х.
